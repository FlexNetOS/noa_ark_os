...
/// Module presenting structured research notebooks generated by autonomous shells.
pub struct ResearchNotebookModule {
    descriptor: ModuleDescriptor,
}

impl ResearchNotebookModule {
    pub fn new() -> Self {
        Self {
            descriptor: ModuleDescriptor::new(
                "research-notebook",
...
impl ShellModule for ResearchNotebookModule {
    fn descriptor(&self) -> &ModuleDescriptor {
        &self.descriptor
    }
    ...
    fn hydrate(&self, context: &ModuleContext) {
        ...
        context.register_workspace(&self.descriptor);
        context.notify(
            "Research notebooks synced from structured exports.",
            NotificationLevel::Info,
        );
    }
}
...
pub fn default_modules() -> Vec<Arc<dyn ShellModule>> {
    ...
    let modules: Vec<Arc<dyn ShellModule>> = vec![
        ...
        Arc::new(ResearchNotebookModule::new()),

    ...
    registry.register_definition(
        CapabilityDefinition::builder(CAPABILITY_PROCESS)
            ...
            .init_with(|_| {
                ...
                Ok(Arc::new(ProcessService::new()) as DynCapability)
            })
            .build(),
    )?;
    ...
    registry.register_definition(
        CapabilityDefinition::builder(CAPABILITY_MEMORY)
            ...
            .init_with(|_| {
                ...
                Ok(Arc::new(MemoryManager::new()) as DynCapability)
            })
            .build(),
    )?;
    ...
    registry.register_definition(
        CapabilityDefinition::builder(CAPABILITY_IPC)
            ...
            .init_with(|_| {
                ...
                Ok(Arc::new(IpcService::new()) as DynCapability)
            })
            .build(),
    )?;
    ...
    registry.register_definition(
        CapabilityDefinition::builder(CAPABILITY_FILESYSTEM)
            ...
            .init_with(|_| {
                ...
                Ok(Arc::new(FileSystemService::new()) as DynCapability)
            })
            .build(),
    )?;
    ...
    registry.register_definition(
        CapabilityDefinition::builder(CAPABILITY_SECURITY)
            ...
            .init_with(|_| {
                ...
                Ok(Arc::new(SecurityService::new()) as DynCapability)
            })
            .build(),
    )?;

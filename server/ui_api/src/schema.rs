                ...
                regions: vec![
                    ...
                    LayoutRegion {
                        ...
                        widgets: vec![
                            ...
                            WidgetSchema {
                                id: "uploads".into(),
                                kind: WidgetKind::WorkspaceUploads,
                                variant: None,
                                props: None,
                                component: Some("UploadPanel".into()),
                            },
                            WidgetSchema {
                                id: "analytics".into(),
                            ...
                            WidgetSchema {
                                id: "automation".into(),
                                kind: WidgetKind::WorkspaceAutomation,
                                variant: None,
                                props: None,
                                component: Some("AutomationPanel".into()),
                            },
                            WidgetSchema {
                                id: "agent-factory".into(),
                                kind: WidgetKind::WorkspaceAgentFactory,
                                variant: None,
                                props: None,
                                component: Some("AgentFactoryPanel".into()),
                            },
                        ],
                    },
                ],

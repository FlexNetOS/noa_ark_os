/**
 * Validates Kanban AI prompt payloads and renders the engineer template.
 * Imported by the Next.js API route inside ui/vibe-kanban.
 */
...
function renderTemplate(template: string, payload: PromptPayload) {
  ...
  const checklistBullets = payload.checklist && payload.checklist.length > 0

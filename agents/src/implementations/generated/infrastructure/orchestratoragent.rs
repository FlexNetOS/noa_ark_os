...
impl Orchestratoragent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "orchestratoragent".to_string(),
            name: "OrchestratorAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Global controller for workflow sequencing, agent execution, event routing, and error retries.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Global controller for workflow sequencing, agent execution, event routing, and error retries.".to_string(),

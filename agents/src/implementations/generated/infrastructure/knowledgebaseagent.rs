...
impl Knowledgebaseagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "knowledgebaseagent".to_string(),
            name: "KnowledgeBaseAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Maintains a semantic knowledge base and answers queries using internal/external data; fully autonomous unless gated data is encountered.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Maintains a semantic knowledge base and answers queries using internal/external data; fully autonomous unless gated data is encountered.".to_string(),

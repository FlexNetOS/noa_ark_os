//! When the Digest Agent - Auto-generated
//! 
...
pub struct WhenTheDigestAgent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl WhenTheDigestAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "when_the_digest_agent".to_string(),
            name: "When the Digest Agent".to_string(),
...
impl Default for WhenTheDigestAgent {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = WhenTheDigestAgent::new();
        assert_eq!(agent.metadata().name, "When the Digest Agent");
    }
    
    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = WhenTheDigestAgent::new();

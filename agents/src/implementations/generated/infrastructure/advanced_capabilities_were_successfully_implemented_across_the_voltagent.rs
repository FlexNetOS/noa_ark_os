...
pub struct AdvancedCapabilitiesWereSuccessfullyImplementedAcrossTheVoltagent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl AdvancedCapabilitiesWereSuccessfullyImplementedAcrossTheVoltagent {
    pub fn new() -> Self {
...
impl Default for AdvancedCapabilitiesWereSuccessfullyImplementedAcrossTheVoltagent {
    fn default() -> Self {
        Self::new()
    }
}

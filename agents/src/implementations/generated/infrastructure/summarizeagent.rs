...
impl Summarizeagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "summarizeagent".to_string(),
            name: "SummarizeAgent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "SummarizeAgent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = Summarizeagent::new();

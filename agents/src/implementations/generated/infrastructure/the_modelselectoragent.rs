//! The ModelSelectorAgent - Auto-generated
//!
...
impl TheModelselectoragent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "the_modelselectoragent".to_string(),
            name: "The ModelSelectorAgent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "The ModelSelectorAgent");
    }

//! Documentation Generator Agent - Auto-generated
//!
...
impl DocumentationGeneratorAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "documentation_generator_agent".to_string(),
            name: "Documentation Generator Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "Documentation Generator Agent");
    }

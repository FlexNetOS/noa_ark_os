//! Orchestration Definition Agent - Auto-generated
//!
...
impl OrchestrationDefinitionAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "orchestration_definition_agent".to_string(),
            name: "Orchestration Definition Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "Orchestration Definition Agent");
    }

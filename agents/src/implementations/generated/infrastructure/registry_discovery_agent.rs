//! Registry/Discovery Agent - Auto-generated
//!
...
impl RegistryDiscoveryAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "registry_discovery_agent".to_string(),
            name: "Registry/Discovery Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "Registry/Discovery Agent");
    }

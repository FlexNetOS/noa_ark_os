...
pub struct Technologyboardagent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl Technologyboardagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "technologyboardagent".to_string(),
            name: "TechnologyBoardAgent".to_string(),
...
impl Default for Technologyboardagent {
    fn default() -> Self {
        Self::new()
    }
}

...
impl MicroAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "micro_agent".to_string(),
            name: "Micro-Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = MicroAgent::new();
        assert_eq!(agent.metadata().name, "Micro-Agent");
    }

...
pub struct Templatemanageragent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl Templatemanageragent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "templatemanageragent".to_string(),
            name: "TemplateManagerAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Selects and fills code templates for new agents (Python, Node, etc.); escalates for new template formats or explicit user review.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Selects and fills code templates for new agents (Python, Node, etc.); escalates for new template formats or explicit user review.".to_string(),
...
impl Default for Templatemanageragent {
    fn default() -> Self {
        Self::new()
    }
}

...
pub struct PcoperatoragentDevops {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl PcoperatoragentDevops {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "pcoperatoragent_devops".to_string(),
            name: "PCOperatorAgent_DevOps".to_string(),
...
impl Default for PcoperatoragentDevops {
    fn default() -> Self {
        Self::new()
    }
}

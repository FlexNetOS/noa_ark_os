//! When a Board Agent - Auto-generated
//!
...
/// When a Board Agent
pub struct WhenABoardAgent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl WhenABoardAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "when_a_board_agent".to_string(),
            name: "When a Board Agent".to_string(),
...
impl Default for WhenABoardAgent {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = WhenABoardAgent::new();
        assert_eq!(agent.metadata().name, "When a Board Agent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = WhenABoardAgent::new();

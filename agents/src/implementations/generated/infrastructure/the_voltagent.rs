...
impl TheVoltagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "the_voltagent".to_string(),
            name: "The VoltAgent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = TheVoltagent::new();
        assert_eq!(agent.metadata().name, "The VoltAgent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = TheVoltagent::new();

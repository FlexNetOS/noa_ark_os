...
impl TheCfoAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "the_cfo_agent".to_string(),
            name: "The CFO Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = TheCfoAgent::new();
        assert_eq!(agent.metadata().name, "The CFO Agent");
    }
    
    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = TheCfoAgent::new();

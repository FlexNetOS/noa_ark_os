...
impl PhaseAgentId {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "phase_agent_id".to_string(),
            name: "Phase Agent ID".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = PhaseAgentId::new();
        assert_eq!(agent.metadata().name, "Phase Agent ID");
    }
    
    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = PhaseAgentId::new();

...
impl Executionplanningagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "executionplanningagent".to_string(),
            name: "ExecutionPlanningAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Plans and sequences agent/app actions to achieve target outcomes; escalates only if goal is unclear or missing critical context.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Plans and sequences agent/app actions to achieve target outcomes; escalates only if goal is unclear or missing critical context.".to_string(),

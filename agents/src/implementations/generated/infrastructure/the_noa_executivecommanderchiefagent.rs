...
pub struct TheNoaExecutivecommanderchiefagent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl TheNoaExecutivecommanderchiefagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "the_noa_executivecommanderchiefagent".to_string(),
            name: "The NOA ExecutiveCommanderChiefAgent".to_string(),
...
impl Default for TheNoaExecutivecommanderchiefagent {
    fn default() -> Self {
        Self::new()
    }
}

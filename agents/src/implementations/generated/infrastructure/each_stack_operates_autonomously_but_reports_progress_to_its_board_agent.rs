...
pub struct EachStackOperatesAutonomouslyButReportsProgressToItsBoardAgent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl EachStackOperatesAutonomouslyButReportsProgressToItsBoardAgent {
    pub fn new() -> Self {
...
impl Default for EachStackOperatesAutonomouslyButReportsProgressToItsBoardAgent {
    fn default() -> Self {
        Self::new()
    }
}

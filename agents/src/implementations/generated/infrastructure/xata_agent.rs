...
impl XataAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "xata_agent".to_string(),
            name: "Xata Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = XataAgent::new();
        assert_eq!(agent.metadata().name, "Xata Agent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = XataAgent::new();

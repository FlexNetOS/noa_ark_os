...
pub struct ByDelegatingModelToolChoiceToADedicatedModelselectoragent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl ByDelegatingModelToolChoiceToADedicatedModelselectoragent {
    pub fn new() -> Self {
...
impl Default for ByDelegatingModelToolChoiceToADedicatedModelselectoragent {
    fn default() -> Self {
        Self::new()
    }
}

...
impl Ingestagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "ingestagent".to_string(),
            name: "IngestAgent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "IngestAgent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = Ingestagent::new();

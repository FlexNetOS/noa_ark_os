...
impl Demoagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "demoagent".to_string(),
            name: "DemoAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Demonstration agent to test proposal workflow.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Demonstration agent to test proposal workflow.".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        ...
        assert_eq!(agent.metadata().name, "DemoAgent");
    }

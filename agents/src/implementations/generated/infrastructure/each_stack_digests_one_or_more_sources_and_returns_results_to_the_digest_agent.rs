...
pub struct EachStackDigestsOneOrMoreSourcesAndReturnsResultsToTheDigestAgent {
    metadata: AgentMetadata,
    state: RwLock<AgentState>,
}

impl EachStackDigestsOneOrMoreSourcesAndReturnsResultsToTheDigestAgent {
    pub fn new() -> Self {
...
impl Default for EachStackDigestsOneOrMoreSourcesAndReturnsResultsToTheDigestAgent {
    fn default() -> Self {
        Self::new()
    }
}

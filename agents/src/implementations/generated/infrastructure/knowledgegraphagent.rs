...
impl Knowledgegraphagent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "knowledgegraphagent".to_string(),
            name: "KnowledgeGraphAgent".to_string(),
            layer: AgentLayer::L5Infrastructure,
            category: AgentCategory::Other,
            agent_type: AgentType::Worker,
            language: AgentLanguage::Rust,
            description: "Builds/maintains a knowledge graph of all entities, dependencies, and operational context; escalates only for ambiguity in new entity relationships.".to_string(),
            role: "Micro Agent".to_string(),
            purpose: "Builds/maintains a knowledge graph of all entities, dependencies, and operational context; escalates only for ambiguity in new entity relationships.".to_string(),

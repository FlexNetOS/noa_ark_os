...
impl CooAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "coo_agent".to_string(),
            name: "COO Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = CooAgent::new();
        assert_eq!(agent.metadata().name, "COO Agent");
    }
    
    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = CooAgent::new();

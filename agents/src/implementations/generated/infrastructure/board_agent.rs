...
impl BoardAgent {
    pub fn new() -> Self {
        let metadata = AgentMetadata {
            id: Uuid::new_v4(),
            agent_id: "board_agent".to_string(),
            name: "Board Agent".to_string(),
...
mod tests {
    ...
    async fn test_agent_creation() {
        let agent = BoardAgent::new();
        assert_eq!(agent.metadata().name, "Board Agent");
    }

    #[tokio::test]
    async fn test_agent_initialization() {
        let mut agent = BoardAgent::new();

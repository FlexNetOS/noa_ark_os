# Crafting High‑Impact Sub‑Agents

> **Goal –** Establish a repeatable playbook for designing small, focused
> “sub‑agents” that Provides like (llama.ccp, Codex, Co-pilot, and Claude) can
> invoke automatically or on‑demand. Follow these practices to get predictable
> routing, strong task performance, and a maintainable agent library.
